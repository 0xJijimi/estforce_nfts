...
contract EstforceNFTs is ERC1155, Ownable, ERC1155Pausable, ERC1155Supply, IERC2981 {
        ...
        Ownable(initialOwner)
    {
        ...
        mintPrice[0] = 10 ether; // Initial mint price (in FTM)
        incrementAmount[0] = 2 ether; // Increment price after each mint (in FTM)
    }
